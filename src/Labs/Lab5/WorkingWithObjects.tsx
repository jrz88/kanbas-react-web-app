...
export default function WorkingWithObjects() {
    ...
    const [module, setModule] = useState({
        ...
        description: "nodejs module description",
    });
    ...
    return (
        <div id="wd-working-with-objects">
            ...
            has this assignment been completed yet?
            <input className="form-check-input" id="wd-assignment-completed-true" type="checkbox"
                checked={assignment.completed} onChange={(e) =>
                    setAssignment({ ...assignment, completed: true })} />
            <label className="form-check-label" htmlFor="wd-assignment-completed-true">
                True
            </label>
